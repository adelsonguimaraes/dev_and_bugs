export class Bug{
    ...
    redraw(ctx: CanvasRenderingContext2D, block: Block) {
    ...
    draw(ctx: CanvasRenderingContext2D, block: Block, level: number) : void {
    ...
    static createModels = async () => {
        ...
        data.forEach((e: object) => this.models.push(new BugModels().fromJson(e)));
    }
}